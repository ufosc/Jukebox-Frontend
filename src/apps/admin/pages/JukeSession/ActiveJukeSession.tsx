  ...
  return (
    <>
      <div className="grid">
        ...
        <div className='col-2'>
          <button className='button-fancy-rounded'>
            End Now
          </button>
        </div>
      </div>
      ...
      <div className='grid'>
        ...
        <div className="col-6 active-juke-session__border active-juke-session__main-container" >
          ...
          <div className='active-juke-session__main-list-header'>
            <div className='active-juke-session__main-list-header__name'>
          ...
          <ul className='active-juke-session__track-list-container'>
            <TrackList tracks={nextTracks} maxCount={4} showIcon={false} showLength={false}/>
          </ul>
            <div className='active-juke-session__button-container'>
